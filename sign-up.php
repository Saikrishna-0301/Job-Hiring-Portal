...
// Query for Insertion
$isactive=1;
//added dobb in function and values
$sql="INSERT INTO tbljobseekers(FullName,EmailId,ContactNumber,Password,Resume,IsActive,DateOfBirth) VALUES(:fname,:emaill,:cnumber,:hashedpass,:resumename,:isactive,:dob)";
...
<div class="col-md-6 col-sm-6">
    ...
    <input type="password" name="jspassword" placeholder="e.g. “Pass@20178”" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
 title="At least one number, one uppercase letter, one lowercase letter, and at least 8 characters" required>
</div>

<!--added dobb-->
<div class="col-md-6 col-sm-6">
<label>Date of Birth<span style="color:red">*</span></label>
<input type="date" name="dateofbirth" placeholder="Date of Birth" required autocomplete="off" style="width: 200px; height: 40px;"/>
